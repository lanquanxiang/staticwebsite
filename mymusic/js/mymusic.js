...
$(function () {
    ...
    $(".progress").bind("click", function (e) {
        ...
        // 计算时间
        var cur_time = width / ($("#progress_bar").parent().width() - $("#timer").width() - 20) * dur_time;
    ...
    function bg(n) {
        r.css({
            'background-image': '-webkit-linear-gradient(left ,#ff410f 0%,#ff410f ' + n + '%,#807e7e ' + n + '%, #807e7e 100%)'
        });
    }
    // 自定义input：range  end
