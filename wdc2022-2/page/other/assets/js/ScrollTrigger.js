...
!function (e, t) {
    ...
    function I(t, e) {
        var r = e.s, n = e.sc, i = ze.indexOf(t), o = n === Xe.sc ? 1 : 2;
    ...
    function J(e, t, i) {
        ...
        var o = e, a = e, s = u(), l = s, n = t || 50, c = Math.max(500, 3 * n);
        return {
            update: _c, reset: function reset() {
                a = o = i ? 0 : o, l = s = 0
    ...
    var he, be, ve, me, Se, _e, Te, ke, Me, t, Pe, r = 1, Oe = [], ze = [], Ye = [], u = Date.now,
        Re = function _bridge(e, t) {
            return t
        }, n = "scrollLeft", i = "scrollTop", Le = {
            s: n,
            p: "left",
            p2: "Left",
            os: "right",
    ...
    var w = (Observer.prototype.init = function init(e) {
        be || M(he) || console.warn("Please gsap.registerPlugin(Observer)"), Me || (Me = he.core.globals().ScrollTrigger) && Me.core && function _integrate() {
            var e = Me.core, r = e.bridge || {}, t = e._scrollers, n = e._proxies;
            t.push.apply(t, ze), n.push.apply(n, Ye), ze = t, Ye = n, Re = function _bridge(e, t) {
                return r[e](t)
            }
        }();
        var i = e.tolerance, a = e.dragMinimum, t = e.type, r = e.target, n = e.lineHeight, o = e.debounce,
            s = e.preventDefault, l = e.onStop, c = e.onStopDelay, u = e.ignore, f = e.wheelSpeed, d = e.event,
            p = e.onDragStart, g = e.onDragEnd, h = e.onDrag, b = e.onPress, v = e.onRelease, m = e.onRight,
            x = e.onLeft, w = e.onUp, S = e.onDown, _ = e.onChangeX, T = e.onChangeY, k = e.onChange, E = e.onToggleX,
            C = e.onToggleY, P = e.onHover, O = e.onHoverEnd, F = e.onMove, Y = e.ignoreCheck, R = e.isNormalizer,
            B = e.onGestureStart, X = e.onGestureEnd, j = e.onWheel, V = e.onEnable, G = e.onDisable, N = e.onClick,
            W = e.scrollSpeed;
        ...
        function we() {
            var e = ee.deltaX = L(de), t = ee.deltaY = L(pe), r = Math.abs(e) >= i, n = Math.abs(t) >= i;
        ...
        function ye(e) {
            if (!ue(e, 1)) {
                var t = (e = K(e, s)).clientX, r = e.clientY, n = t - ee.x, i = r - ee.y, o = ee.isDragging;
        ...
        function Fe(e) {
            if (!ue(e)) {
                var t = e.clientX, r = e.clientY, n = t - ee.x, i = r - ee.y;
        ...
        var q, U, Z, $, Q, ee = this, te = 0, re = 0, ne = I(r, Le), ie = I(r, Xe), oe = ne(), ae = ie(),
            ...
            le = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === se[0], ce = y(r),
            fe = r.ownerDocument || me, de = [0, 0, 0], pe = [0, 0, 0], ge = ee.onPress = function (e) {
    ...
    function rb(e, t, r, n, i, o, a, s) {
        var l = i.startColor, c = i.endColor, u = i.fontSize, f = i.indent, d = i.fontWeight,
            p = Ne.createElement("div"), g = ya(r) || "fixed" === x(r, "pinType"), h = -1 !== e.indexOf("scroller"),
            b = g ? We : r, v = -1 !== e.indexOf("start"), m = v ? l : c,
    ...
    function cc(l, e) {
        function nj(e, t, r, n, i) {
            var o = nj.tween, a = t.onComplete, s = {};
        ...
        var c, u, f = I(l, e), d = "_scroll" + e.p2;
        return (l[d] = f).wheelHandler = function () {
            return nj.tween && nj.tween.kill() && (nj.tween = 0)
        }, kb(l, "wheel", f.wheelHandler), nj
    }

    var je, o, Ve, Ne, Ke, We, a, s, qe, Je, Ue, l, Ze, $e, c, Qe, f, d, g, et, tt, h, b, v, m, S, rt, _, nt, T, it, ot,
        at = 1, st = Date.now, k = st(), lt = 0, ct = 0, ut = Math.abs, C = "right", P = "bottom", ft = "width",
        dt = "height", pt = "Right", gt = "Left", ht = "Top", bt = "Bottom", vt = "padding", mt = "margin",
        yt = "Width", O = "Height", xt = "px", wt = function _getBounds(e, t) {
        ...
        }, St = {startColor: "green", endColor: "red", indent: 0, fontSize: "16px", fontWeight: "normal"},
        _t = {toggleActions: "play", anticipatePin: 0}, F = {top: 0, left: 0, center: .5, bottom: 1, right: 1},
        Y = function _positionMarker(e, t, r, n) {
        ...
        }, Tt = [], kt = {}, R = {}, B = [], X = [], j = function _dispatch(e) {
            return R[e] && R[e].map(function (e) {
                return e()
            }) || B
        }, V = [], G = function _revertRecorded(e) {
            ...
            t && G(t), t || j("revert")
        }, W = 0, q = function _refreshAll(e, t) {
            if (!lt || e) {
                it = !0;
                var r = j("refreshInit");
        ...
        }, U = 0, Et = 1, Z = function _updateAll() {
            if (!it) {
                ot && ot.update(0), re.isUpdating = !0;
                var e = Tt.length, t = st(), r = 50 <= t - k, n = e && Tt[0].scroll();
        ...
        ee = /([A-Z])/g, Ct = function _setState(e) {
            if (e) {
        ...
        }, Mt = {left: 0, top: 0}, te = /(webkit|moz|length|cssText|inset)/i,
        re = (ScrollTrigger.prototype.init = function init(_, T) {
            if (this.progress = this.start = 0, this.vars && this.kill(!0, !0), ct) {
                var v, n, f, k, E, C, M, P, O, A, D, e, z, F, Y, R, L, t, B, m, X, j, y, V, w, S, r, G, N, K, i, d, W,
                    q, J, U, Z, o, $ = (_ = cb(Ea(_) || Ga(_) || _.nodeType ? {trigger: _} : _, _t)).onUpdate,
                    Q = _.toggleClass, a = _.id, ee = _.onToggle, te = _.onRefresh, re = _.scrub, ne = _.trigger,
                    ie = _.pin, oe = _.pinSpacing, ae = _.invalidateOnRefresh, se = _.anticipatePin,
                    s = _.onScrubComplete, p = _.onSnapComplete, le = _.once, ce = _.snap, ue = _.pinReparent,
                    l = _.pinSpacer, fe = _.containerAnimation, de = _.fastScrollEnd, pe = _.preventOverlaps,
                    ge = _.horizontal || _.containerAnimation && !1 !== _.horizontal ? Le : Xe, he = !re && 0 !== re,
                    be = H(_.scroller || Ve), c = je.core.getCache(be), ve = ya(be),
                    ...
                    we = ve ? 0 : parseFloat(ab(be)["border" + ge.p2 + yt]) || 0, Se = this,
                ...
                if (Se.media = nt, Se._dir = ge, se *= 45, Se.scroller = be, Se.scroll = fe ? fe.time.bind(fe) : Ee, k = Ee(), Se.vars = _, T = T || _.animation, "refreshPriority" in _ && (et = 1, -9999 === _.refreshPriority && (ot = Se)), c.tweenScroll = c.tweenScroll || {
                ...
                }, T && (T.vars.lazy = !1, T._initted || !1 !== T.vars.immediateRender && !1 !== _.immediateRender && T.render(0, !0, !0), Se.animation = T.pause(), (T.scrollTrigger = Se).scrubDuration(re), G = 0, a = a || T.vars.id), Tt.push(Se), ce && (Ha(ce) && !ce.push || (ce = {snapTo: ce}), "scrollBehavior" in We.style && je.set(ve ? [We, Ke] : be, {scrollBehavior: "auto"}), f = Fa(ce.snapTo) ? ce.snapTo : "labels" === ce.snapTo ? function _getClosestLabel(t) {
                    return function (e) {
                    ...
                    if (Math.abs(Se.getVelocity()) < 10 && !$e && g !== Ee()) {
                        var e = T && !he ? T.totalProgress() : Se.progress, t = (e - N) / (st() - Ue) * 1e3 || 0,
                            r = je.utils.clamp(-Se.progress, 1 - Se.progress, ut(t / 2) * t / .185),
                            n = Se.progress + (!1 === ce.inertia ? 0 : r), i = Je(0, 1, f(n, Se)), o = Ee(),
                            a = Math.round(C + i * z), s = ce.onStart, l = ce.onInterrupt, c = ce.onComplete,
                            u = v.tween;
                        if (o <= M && C <= o && a !== o) {
                    ...
                    }(ve ? We : be), je.set([A, D], {force3D: !0}), w = je.quickSetter(A, ge.a, xt), S = je.quickSetter(D, ge.a, xt))
                }
                if (fe) {
                    var b = fe.vars.onUpdate, Ce = fe.vars.onUpdateParams;
                ...
                Se.previous = function () {
                    ...
                    var e = Tt.indexOf(Se), r = 0 < Se.direction ? Tt.slice(0, e).reverse() : Tt.slice(e + 1);
            ...
            if (Ve = window, Ne = document, Ke = Ne.documentElement, We = Ne.body, je && (qe = je.utils.toArray, Je = je.utils.clamp, tt = je.core.suppressOverwrites || ua, je.core.globals("ScrollTrigger", ScrollTrigger), We)) {
                ...
                var e, t, r = We.style, n = r.borderTopStyle;
                for (r.borderTopStyle = "solid", e = wt(We), Xe.m = Math.round(e.top + Xe.sc()) || 0, Le.m = Math.round(e.left + Le.sc()) || 0, n ? r.borderTopStyle = n : r.removeProperty("border-top-style"), l = setInterval(wb, 250), je.delayedCall(.5, function () {
                    ...
                    var e = Ve.innerWidth, t = Ve.innerHeight;
            ...
            var r = H(e), n = ze.indexOf(r), i = ya(r);
            ...
            var n = (Ea(e) ? H(e) : e).getBoundingClientRect(), i = n[r ? ft : dt] * t || 0;
    ...
    function gc(e) {
        ...
        var t, r, n, o, s, a, l, c, u, f = e.normalizeScrollX, i = e.momentum, d = 0, p = I(Ke, Xe), g = I(Ke, Le),
            h = 1, b = Fa(i) ? function () {
                return i(t)
            } : function () {
                return i || 2.8
            }, v = ua, m = ua, y = re.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent);
        return e.ignoreCheck = function (e) {
            ...
            var r = e.event, n = r.changedTouches ? r.changedTouches[0] : r;
            ...
            fc(!f && "x"), kb(Ve, "resize", Bo), e.target.addEventListener("click", po, {capture: !0})
    ...
    re.sort = function (e) {
        ...
        _getVelocityProp: J, _scrollers: ze, _proxies: Ye, bridge: {
            ss: function ss() {
